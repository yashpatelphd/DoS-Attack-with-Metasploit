...
3. Open Wireshark to capture and analyze the network traffic generated by the SYN flood:
  
   ***wireshark***

4. Set filters to isolate the SYN packets or to view the traffic between the attacker and victim machines. Notice the pattern of repeated SYN packets, indicating the flood of requests overwhelming the target.
